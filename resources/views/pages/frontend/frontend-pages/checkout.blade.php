                ...
                @if($payment_method_data['payment_option']['enable_payment_method'] == 'yes' && ($payment_method_data['bacs']['enable_option'] == 'yes' || $payment_method_data['cod']['enable_option'] == 'yes' || $payment_method_data['paypal']['enable_option'] == 'yes' || $payment_method_data['stripe']['enable_option'] == 'yes'))
                  <div class="payment-options">
                   ...
                   @endif
                       ...
                       <span>
                     <label>
                       @if(old('payment_option') == 'sslcommerz')
                         <input type="radio" checked name="payment_option" class="shopist-iCheck" value="sslcommerz"> sslcommerz
                       @else
                         <input type="radio" name="payment_option" class="shopist-iCheck" value="sslcommerz"> sslcommerz
                       @endif
                     </label>
                    </span>
